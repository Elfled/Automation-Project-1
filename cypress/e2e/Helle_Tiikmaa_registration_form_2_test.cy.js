...
// Define the function for all mandatory fields + password
function fillMandatoryFields(userName, email, firstName, lastName, phoneNumber, password) {
    ...
    // Fill in the form fields in the order they appear on the UI page
    ...
    cy.get('[data-testid="phoneNumberTestId"]').clear().type(phoneNumber); // Fill in the phone number field
    cy.get('#password').type(password); // Fill in the password field
    cy.get('#confirm').type(password); // Fill in the confirmation password field
}

// Define the function for mandatory fields without password
...
describe('Section 1: Functional tests', () => {
    ...
    // Fill in only mandatory fields + password - call function 'fillMandatoryFields'
